...
const Profile = (0, import_index_c6d9d557.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_profiles = (0, import_index_c6d9d557.a)(import_Header_93cc05b7.a, (value) => $profiles = value);
  let { profileId } = $$props;
  let { username } = $$props;
  let { fullName } = $$props;
  let { followers } = $$props;
...
${(0, import_index_c6d9d557.v)(import_Header_93cc05b7.H, "Header").$$render($$result, {}, {}, {})}
...
async function load({ page }) {
  ...
  try {
    const user = await import_firebase_060a07e6.f.firestore().collection("users").where("username", "==", pageId).get();
