...
var import_Header_93cc05b7 = __toModule(require("../../chunks/Header-93cc05b7.js"));
...
const Timeline = (0, import_index_c6d9d557.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_users = (0, import_index_c6d9d557.a)(import_Header_93cc05b7.c, (value) => value);
  $$unsubscribe_users();
...
const Dashboard = (0, import_index_c6d9d557.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_users = (0, import_index_c6d9d557.a)(import_Header_93cc05b7.c, (value) => $users = value);
  $$unsubscribe_users();
  return `${$$result.head += `${$$result.title = `<title>Instagram</title>`, ""}`, ""}

<div class="${"bg-gray-50 "}">${(0, import_index_c6d9d557.v)(import_Header_93cc05b7.H, "Header").$$render($$result, {}, {}, {})}
...
<section class="${"svelte-8cruuo"}">${(0, import_index_c6d9d557.v)(App, "App").$$render($$result, { firebase: import_firebase_060a07e6.f, FieldValue: import_firebase_060a07e6.F }, {}, {})}</section>`;
});
